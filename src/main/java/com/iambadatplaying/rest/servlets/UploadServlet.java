...
//        Path path = starter.getConfigLoader().getAppFolderPath().resolve(ConfigLoader.USER_DATA_FOLDER_NAME + File.separator + ConfigLoader.BACKGROUNDS_FOLDER_NAME);
//
...
//        serveFile(req, resp, path);
    ...
    private void serveFile(HttpServletRequest req, HttpServletResponse resp, Path path) {
        ...
        log("Serving file: " + file.getAbsolutePath());
        if (!file.exists()) {
    ...
    private void handleUploadBackground(HttpServletRequest req, HttpServletResponse resp) {
        Path path = starter.getConfigLoader().getAppFolderPath().resolve(
                ConfigLoader.USER_DATA_FOLDER_NAME + File.separator + ConfigLoader.BACKGROUNDS_FOLDER_NAME).resolve("background");
...
//                                        BackgroundModule.CLIENT_BACKGROUND_TYPE.LOCAL_IMAGE.toString()
//                                );
//                                break;
//                            case "video/mp4":
//                            case "video/webm":
...
//                                configLoader.setClientProperty(
//                                        ConfigLoader.PROPERTY_CLIENT_BACKGROUND_TYPE,
//                                        BackgroundModule.CLIENT_BACKGROUND_TYPE.LOCAL_VIDEO.toString()
//                                );
//                                break;
//                            default:
...
//                    .replace(
//                            configLoader.getAppFolderPath().toString()+
//                                    File.separator+ConfigLoader.USER_DATA_FOLDER_NAME+
//                                    File.separator+ConfigLoader.BACKGROUNDS_FOLDER_NAME+
